package Perlbrew::Utils::Config::File::INI::Parser;
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new Perlbrew::Utils::Config::File::INI::Parser(@_);
...
=head1 NAME
 ...
 Perlbrew::Utils::Config::File::INI::Parser
...
=head1 SYNOPSIS
 ...
 my $parser = Perlbrew::Utils::Config::File::INI::Parser(masterConfigFile=>$file);
