...
B<Description:> Instantiate Perlbrew::Utils::Logger object

B<Parameters:> 

 %args

B<Returns:> Returns a reference to Perlbrew::Utils::Logger
...
sub _initConfiguration {
    ...
    my $conf = q(
    log4perl.logger                    = sub {return Perlbrew::Utils::Logger::_getLogLevel();}

    log4perl.appender.Logfile          = Log::Log4perl::Appender::File
    log4perl.appender.Logfile.filename = sub { return Perlbrew::Utils::Logger::_getLogfile(); }
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new Perlbrew::Utils::Logger(@_);

        if (!defined($instance)){
            confess "Could not instantiate Perlbrew::Utils::Logger";
        }
    }
...
B<Description:> Perlbrew::Utils::Logger class destructor
...
=head1 SYNOPSIS
 ...
 my $obj = Perlbrew::Utils::Logger::getInstance();
